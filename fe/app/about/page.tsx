...
export default function AboutPage() {
  const socialActions = [
    { 
      ...
      className: "bg-white/5 border border-white/10 text-zinc-400 hover:bg-black hover:text-white hover:border-black/50 hover:shadow-[0_0_30px_rgba(0,0,0,0.5)]"
    },
    { 
      label: "LinkedIn", 
      icon: Linkedin, 
      href: "https://linkedin.com", 
      className: "bg-white/5 border border-white/10 text-zinc-400 hover:bg-[#0077b5] hover:text-white hover:border-[#0077b5]/50 hover:shadow-[0_0_30px_rgba(0,119,181,0.5)]"
    },
    { 
      label: "Twitter", 
      icon: Twitter, 
      href: "https://twitter.com", 
      className: "bg-white/5 border border-white/10 text-zinc-400 hover:bg-[#1DA1F2] hover:text-white hover:border-[#1DA1F2]/50 hover:shadow-[0_0_30px_rgba(29,161,242,0.5)]"
    },
    { 
      label: "Email", 
      icon: Mail, 
      href: "mailto:hello@example.com", 
      className: "bg-white/5 border border-white/10 text-zinc-400 hover:bg-orange-500 hover:text-white hover:border-orange-500/50 hover:shadow-[0_0_30px_rgba(249,115,22,0.5)]"
    },
  ];
          ...
          >
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="space-y-4">
                <h1 className="text-2xl md:text-4xl font-extrabold text-white tracking-tight">
                  Hi, I'm <span className="text-blue-500">Kuchikamizake.</span>
                </h1>
                <p className="text-base md:text-lg text-zinc-400 font-light leading-relaxed max-w-xl">
                  Digital Architect & Full-stack Engineer crafting premium web experiences that live on the edge of innovation.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4 mt-8 relative z-10">
              ...
              >
                ...
                <span className="relative z-10 group-hover/btn:text-black transition-colors duration-300">Resume / CV</span>
              </a>
              <a 
                href="#contact" 
                className="relative h-[46px] px-8 rounded-full border border-white/10 text-white font-bold text-xs md:text-sm tracking-wide flex items-center gap-2 overflow-hidden group/btn"
              >
                <div className="absolute inset-0 bg-white translate-y-[101%] group-hover/btn:translate-y-0 transition-transform duration-300 ease-out" />
                <span className="relative z-10 group-hover/btn:text-black transition-colors duration-300">Contact Me</span>
              </a>
            </div>
          </motion.div>
