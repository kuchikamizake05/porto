...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  aspectRatio = '0.718',
  avatarScale = 1,
  avatarBottomOffset = '-1px',
  avatarBlendMode = 'luminosity',
  onContactClick
}) => {
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--pattern': patternUrl ? `url(${patternUrl})` : 'none',
    ...
    [iconUrl, patternUrl, grainUrl, innerGradient, behindGlowColor, behindGlowSize, cardRadius]
  );
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            {patternOverlayOpacity > 0 && patternUrl && (
              <div
            ...
            >
              <Image
                ...
                style={{
                  ...
                  transform:
                    `translateX(calc(-50% + (var(--pointer-from-left) - 0.5) * 6px)) translateZ(0) scale(${avatarScale}) scaleY(calc(1 + (var(--pointer-from-top) - 0.5) * 0.02)) scaleX(calc(1 + (var(--pointer-from-left) - 0.5) * 0.01))`,
